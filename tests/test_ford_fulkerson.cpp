...
TEST(TestFordFulkerson, TestMinCutSimple) {
    ...
    ASSERT_EQ(ford_fulkerson_min_cut(g, 0, 5), (std::vector<std::pair<int, int>>({{0, 1}, {0, 3}})));
    ASSERT_EQ(ford_fulkerson_min_cut(g, 0, 1), (std::vector<std::pair<int, int>>({{0, 1}, {0, 3}})));
...
TEST(TestFordFulkerson, TestMinCutGenerated) {
    ...
    g[23].push_back(145);
    g[23].push_back(146);
    ASSERT_EQ(ford_fulkerson_min_cut(g, 0, 199), (std::vector<std::pair<int, int>>({{23, 145}, {23, 146}, {34, 137}})));
    ...
    ASSERT_EQ(ford_fulkerson_min_cut(g, 0, 199),
              (std::vector<std::pair<int, int>>({{23, 145}, {23, 146}, {34, 137}, {42, 133}, {69, 111}})));
